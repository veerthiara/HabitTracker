...
def upgrade() -> None:
    ...
    op.create_index("ix_bottle_events_user_id", "bottle_events", ["user_id"])
    op.create_index("ix_bottle_events_event_ts", "bottle_events", ["event_ts"])
    ...
    op.create_index(
        "ix_daily_summaries_date", "daily_summaries", ["user_id", "summary_date"]
    )
